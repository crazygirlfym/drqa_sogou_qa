...
if __name__ == "__main__":
    ...
    # -train-data=/media/iscas/linux/fym/data/train_data_sogou/train.pt -valid-file=/media/iscas/linux/fym/data/pre_data/ valid_factoid.pt -valid-data=/media/iscas/linux/fym/data/train_data_sogou/valid.pt
